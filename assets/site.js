function makeHeader(currentPage) {
  ...
  return `
    ...
    <header class="site-header" id="site-header">
      <div class="nav-wrap">
        <a class="brand brand-inline" href="index.html" aria-label="Coblentz Country Cabins home">
          <span class="brand-mark">Coblentz Country Cabins</span>
        </a>
        ...
        <nav id="primary-nav" class="nav-links" aria-label="Primary">
          ${nav}
          <a class="button" href="https://reserve.amishcountrylodging.com/all-listings?category=16008" target="_blank" rel="noreferrer">Book Now</a>
        </nav>
      </div>
    </header>
  `;
  ...
  return `
    <footer class="site-footer">
      <div class="footer-inner">
        <div>
          <div class="brand-mark" style="color:var(--ink)">Coblentz Country Cabins</div>
          <p style="color:var(--muted);margin:0.5rem 0 0">Rustic log cabins &amp; lodge suites in Berlin, Ohio — direct booking available.</p>
        </div>
        <ul class="footer-links">
          ...
          <li><a href="tel:13308938007">(330) 893-8007</a></li>
        </ul>
        <div class="kicker">Coblentz Country Cabins &middot; 5130 Township Hwy 359, Berlin, OH 44610</div>
      </div>
    </footer>
  `;
}
